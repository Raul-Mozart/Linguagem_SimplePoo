"""
Pacote de módulos léxicos - Compilador de Expressões Regulares
...
from .analisador import LexicalAnalyzer

__all__ = ['compile_regex_to_dfa', 'DFA', 'NFA', 'EstadoNFA', 'LexicalAnalyzer']
__version__ = '1.0.0'